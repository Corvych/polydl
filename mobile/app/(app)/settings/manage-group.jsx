...
import { Users, Settings, Copy, Trash2, Shield, Building } from 'lucide-react-native';
    ...
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.center}>
          ...
          <Text style={styles.noGroupSubtext}>Join a group from your profile to access group management.</Text>
        </View>
      </SafeAreaView>
    );
  }
